...
import { level2ByLevel1, sections } from '@/data/question-bank';
import type { FormData, Question, Section } from '@/types/valuation';
...
export function Questionnaire({
  ...
  const updateField = (question: Question, nextValue: string | boolean) => {
        ...
        <div className="mx-auto max-w-5xl px-6 py-5">
          <div className="mb-4 flex items-center justify-between gap-4">
            <a href="/" className="flex items-center gap-2">
              <img src="/logo-mark.png" alt="Afrexit logo" className="w-10 h-10 object-contain shrink-0" />
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        <div className="mb-6 rounded-2xl border border-purple-100 bg-purple-50 p-5">
          <p className="text-sm leading-7 text-purple-900">
            Complete all sections for the most accurate valuation. Your responses help us calculate a detailed 
            estimate based on industry-specific benchmarks and buyer-ready criteria.
          </p>
        </div>
